...
real-world programming. Our research presented a novel approach to 
introducing refinement types in an imperative programming language that 
closely resembles real-world programming languages, allowing our work to be more 
...
built on the WHILE language and supports refinement types. Validating the 
