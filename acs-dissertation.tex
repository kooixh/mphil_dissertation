...
\begin{figure} [H]
  \begin{tabs}{1cm,2cm}
    \textbf{let }$y\text{ }:\text{ } int \textit{ ref} = \textbf{new}(int)$\textbf{ in } y := 10; \\
    \textbf{let }$x\text{ }:\text{ }int\textit{ ref} = y$\textbf{ in } \\
    \tab\textbf{typedef }$BoundedIntY$ = $\Pi y : int\text{ ref}. \{i : Int\text{ }|\text{ }i < !y\}$ \textbf{ in } \\ 
    \tab\tab\textbf{let }$z\text{ }:\text{ }BoundedIntY = 6$ \textbf{ in }$x := 5$\textbf { end }\\
...
acts as its alias, i.e. both $x$ and $y$ points to the same memory address, 
