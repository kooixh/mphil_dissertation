...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      ...
      & \\
      \inference {\Gamma \vdash e_1: T_1 & \Gamma,x : T_1 \vdash C_1 : void & \Gamma, x : T_1 \vdash e_2: T_2} 
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      ...
      & \\
      \inference {\Gamma \vdash T_2 & \Gamma \vdash T_1 \preceq T_2 & \Gamma \vdash x : T_1} 
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      {\langle\textbf{let var }x : T = v_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma \rangle 
      \Longrightarrow \langle v_1, \sigma'' \setminus \{x\} \rangle} [(\textbf{let in} values)] 
      & \\
      \footnotesize
      \inference {\langle e_1, \sigma \rangle \Longrightarrow \langle e_1', \sigma\rangle} 
      {\langle \textbf{let var }x : T = e_1 \text{\textbf{ in }} C_1;e_2 \text{\textbf{ end}}, \sigma \rangle 
      \Longrightarrow \langle\textbf{let var }x : T = e_1' \text{\textbf{ in }} C_1;e_2\text{\textbf{ end}}, \sigma \rangle} 
      [(\textbf{let in} $expr$)]
      \normalsize
    \end{tabular}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      \inference {\sigma' = \sigma + \{x \mapsto v_0\} & x \notin \sigma 
      \\ \langle P(v_1), \sigma, \tau \rangle \Longrightarrow^{*} \langle true, 
      \sigma', \tau' \rangle
      \\ \langle C_1, \sigma' \rangle \longrightarrow \sigma''
      & \langle e_1, \sigma'' \rangle \Longrightarrow^{*} \langle v_1, \sigma'' \rangle} 
      {\langle\textbf{let var }x : \{\upsilon : T\text{ }|\text{ }P(\upsilon)\} = v_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma \rangle 
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      ...
      \\ \langle C_1, \sigma, \tau' \rangle \longrightarrow \langle \sigma', \tau'' \rangle & \langle e_1, \sigma', \tau'' \rangle \Longrightarrow^{*} \langle v, \sigma', \tau'' \rangle}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      \inference {y \in \textbf{dom}(\tau) & A = \tau(y)} 
      {\langle\textbf{let var }x : y = e_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma, \tau \rangle 
      \Longrightarrow \langle\textbf{let var }x : A = e_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma, \tau \rangle }
    \end{tabular}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      {\langle \text{\textbf{let const }}x = v \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma \rangle 
      ...
      {\langle \text{\textbf{const }}x = e_1 \text{\textbf{ in }} C_1;e_2 \text{\textbf{ end}}, \sigma \rangle 
      \Longrightarrow \langle \text{\textbf{const }}x = e_1' \text{\textbf{ in }} C_1;e_2\text{\textbf{ end}}, \sigma \rangle} 
      [(\textbf{const in} $expr$)]
      & \\
      \inference {x \in \textbf{dom}(\sigma) & \neg is\_immutable(x)} 
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      \forall \alpha \in \sigma \cap free\_vars(P(\upsilon))\text{ }s.t.\text{ }is\_immutable(\alpha)
      \\ \langle C_1, \sigma, \tau + \{a \mapsto \{\upsilon :A\text{ }|\text{ }P(\upsilon)\} 
      \rangle \longrightarrow \langle \sigma', \tau' \rangle
      \\ \langle e_1, \sigma', \tau' \rangle \Longrightarrow^{*} \langle v, \sigma', \tau' \rangle}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      \footnotesize
      \inference {
      \langle e_1, \sigma', \tau' \rangle \Longrightarrow \langle v, \sigma'', \tau'', \mathcal{R}''' \rangle
      \\ \langle C_1, \sigma, \tau + \{y \mapsto \{\upsilon : A\text{ }|\text{ 
      }P(\upsilon)\}\}, \mathcal{R}'
      \rangle \longrightarrow \langle \sigma', \tau', \mathcal{R}''\rangle      
      \\ \sigma_1 = \sigma & \tau_1 = \tau & \mathcal{R}_1 & \mathcal{R}' = \mathcal{R} + \{y \mapsto (\sigma_1, \tau_1, \mathcal{R}_1)\}}
      {\langle\textbf{let typedef } y = \{\upsilon : A\text{ }|\text{ }P(\upsilon)\} \textbf{ in }C_1;e_1\textbf{ end}, 
      \sigma, \tau, \mathcal{R} \rangle \Longrightarrow \langle v, \sigma'', \tau'' \setminus \{y\}, \mathcal{R}''' \setminus \{y\} \rangle} 
      \normalsize
    \end{tabular}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      \\  \sigma' = \sigma + \{x \mapsto v_0\} & (\sigma_1, \tau_1, \mathcal{R}_1) = \mathcal{R}(y) 
      \\ \langle P(v_0), \sigma_1, \tau_1, \mathcal{R}_1 \rangle \Longrightarrow^{*} \langle true, 
      \sigma_1', \tau_1', \mathcal{R}_1' \rangle
      \\ \langle C_1, \sigma', \tau, \mathcal{R} \rangle \longrightarrow \langle 
      \sigma'', \tau', \mathcal{R}' \rangle
      & \langle e_1, \sigma'', \tau', \mathcal{R}' \rangle \Longrightarrow^{*} \langle v_1, \sigma''', \tau'', \mathcal{R}''  \rangle} 
      {\langle\textbf{let var }x : y = v_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma, \tau, \mathcal{R} \rangle 
      \Longrightarrow \langle v_1, \sigma''' \setminus \{x\}, \tau'', \mathcal{R}'' \rangle} [(\textbf{let in} values)] 
    \end{tabular}
  \end{center}
\end{figure}
