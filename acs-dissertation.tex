...
languages such as \textit{Java} \cite{java}, \textit{C} and \textit{C++} \cite{cpp} 
uses the former while languages like \textit{Python} and \textit{JavaScript} uses the latter. 
