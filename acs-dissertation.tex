...
value can be retrieve and modify through dereferencing, shwon in the first two 
rules. A $nil$ reference is not allocated in the state $\Delta$ 
and cannot be deference. 
