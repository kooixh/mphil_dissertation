...
\par
The lack of referencing allows us to define semantics that absolutely forbin 
modification on a heap location. We define the operational semantics for the 
new expression in figure \ref{fig:sos_const_ptr} that restrict the ability to 
modify the value of a constant heap address.
