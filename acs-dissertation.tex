...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{l l l}
      ...
      \textit{Functions} & $f$ & $f(x_1,x_2,...x_n) = C;e$\\
...
and a refinement predicate $P(\upsilon)$ on $T$. A refinement predicate is 
simply a boolean expression.
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      \inference {\Gamma \vdash \upsilon : T_1 & \Gamma \vdash P(\upsilon) : bool & \Gamma, \upsilon : T_1 \vdash P(\upsilon) = true}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      {\langle\textbf{let var }x = v_0 \text{\textbf{ in }} C_1;e_1 \text{\textbf{ end}}, \sigma \rangle 
      \Longrightarrow \langle v_1, \sigma'' \setminus \{x\} \rangle} [(\textbf{let in} values)] 
      & \\
      \inference {\langle e_1, \sigma \rangle \Longrightarrow \langle e_1', \sigma\rangle} 
      {\langle \textbf{let var }x = e_1 \text{\textbf{ in }} C_1;e_2 \text{\textbf{ end}}, \sigma \rangle 
      \Longrightarrow \langle\textbf{let var }x = e_1' \text{\textbf{ in }} C_1;e_2\text{\textbf{ end}}, \sigma \rangle} 
      [(\textbf{let in} $expr$)]
    \end{tabular}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      \inference {
      \sigma_1 = \sigma & \tau_1 = \tau
      \\ \langle P(\upsilon), \sigma_1, \tau_1 \rangle \Longrightarrow \langle e, \sigma_1', \tau_1' \rangle
      \\ \langle C_1, \sigma, \tau + \{y \mapsto \{\upsilon : A\text{ }|\text{ }e\}\} \rangle \longrightarrow \langle \sigma', \tau' \rangle
      \\ \langle e_1, \sigma', \tau' \rangle \Longrightarrow \langle v, \sigma', \tau' \rangle}
