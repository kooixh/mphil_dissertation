...
\par
Mainstream programming languages often follow the imperative programming 
...
changes has the potential making their semantics unclear. 
...
the theoretical aspects and are highly technical and complex, 
...
declare variables, in some cases one might not be able to declare 
...
into imperative programming and it can be extended with 
