...
immutabile object which will be key in the study of refinement types in 
...
checking mechanics are combined in feature-rich langauges like Java in order to 
...
evaluation rules. When one declare a variable of a refinement type, the language 
