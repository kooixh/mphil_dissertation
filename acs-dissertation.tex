...
formalise the basic semantics. Throughout the dissertation we will use the following 
metavariables. 
\begin{itemize}
...
\section{Dependent Types Definitions}
In this section we will define the semantics regarding dependent types. 
...
\begin{center}
  $y\text{ }:\text{ }int = 10$ \\
  $BoundedInt<y>$ = $\Pi y. \{i : Int\text{ }i < y\}$
\end{center}
\par
...
this subsection we will define semantics to formalise the behavour.
