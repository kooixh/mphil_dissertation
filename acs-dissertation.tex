...
\par
In this section we extended our language with advanced features such as pointers 
and aliasing. We observe how introducing new form of variables introduces new 
form of mutation into the language and will require us to adapt new strategies 
in our language specification. Finally we extended our previously defined 
semantics to accomodate this new feature. Our use of closures can easily be 
modified to work with pointers with a similar strategy. As it is very similar 
the appraoch discussed here, we have left the specification out of the text. The 
semantics of using closures with pointers is included in the appendencies. 
