...
\begin{figure}[H]
  ...
  \end{lstlisting}
  \caption{Intended Behaviour of LessThanN}
\end{figure}
...
invalid value into a constructor, i.e. a value greater than N, 
...
\textit{constexpr} and \textit{static_assertation}. These allow for certain 
