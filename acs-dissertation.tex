...
expect from a refinement types and the benefits of using refinement types. 
...
\par
Past research has studied and shown the feasibility of an dependently typed 
imperative language, however these studies focused on expressing the semantics 
of an imperative language and dependent types as a whole. They are often highly 
...
requirement of accessibility with its simple syntax and semantics. Using the 
...
\begin{enumerate}
  \item Survey the state of dependent and refinement typed languages 
  and their differences.
  \item Describe a refinement typed imperative language based on the WHILE 
  language.
  \item  Explore the ambiguity of refinement types in an imperative environment 
  with mutation.
