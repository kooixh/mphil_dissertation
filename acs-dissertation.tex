...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      {\langle \text{\textbf{let }}x = v_0 \text{\textbf{ in }} e_1 \text{\textbf{ end}}, \sigma \rangle 
...
Let $\{S\}e_1\{T\}$ be a Hoare triple and we have a type declaration defined as 
\begin{center}
...
function, we delcare precondition as $Q$ on our type declaration
\begin{center}
