...
\begin{figure}[H]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Operational Semantics for Simple-$R$ Expression}
  \label{fig:sos_expr}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Operational Semantics for Refinement Type with Closures}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Type Checking in Simple-$R_{C}$}
...
\begin{figure}[H]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Operational Semantics of Refinement Type in Simple-$R^{*}_{C}$}
\end{figure}
...
address this problem by adapting the concept of pointers to 
