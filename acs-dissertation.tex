...
\begin{figure}[H]
  \begin{center}
    \begin{tabular}{c}
      ...
      \inference {
      x \notin \text{\textbf{dom}}(\sigma) & x \notin \textbf{dom}(\tau) \\
      \forall \alpha \in \textit{free\_vars}(e).text{ }is\_immutable(\alpha)
      \\ \langle C_1, \sigma + \{x \mapsto v_1\} , \tau
      \rangle \longrightarrow \langle \sigma', \tau \rangle}
      {\langle\textbf{begin var }x : \{\upsilon : T\text{ }|\text{ }e\} = v_1;C_1 \textbf{ end}, \sigma, \tau, \mathcal{R} \rangle 
...
\begin{figure}[H]
  \begin{center}
    \begin{tabular} {c}
      ...
      \\ \langle C_1, \sigma, \tau + \{y \mapsto (\{\upsilon : A\text{ }|\text{ }e\}\}, \sigma_1, \tau_1)
      \rangle \longrightarrow^{*} \langle \sigma', \tau\rangle}
