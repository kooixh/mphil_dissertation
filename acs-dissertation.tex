...
In order to formalise the behaviour in Hoare Logic, we have to 
modify out syntax to include this necessary information. 
...
\begin{figure}[H]
  \begin{center}
    \footnotesize$\{\tau = \{\alpha : \beta \in\text{\textbf{dom}}(\Gamma)\text{ }|\text{ }\beta = \Pi a'. P(a')\}\}a := e\{\Gamma(a) = e \wedge 
